...
namespace Microsoft.Azure.WebJobs.Host.Queues.Listeners
{
    internal sealed class QueueListener : IListener, ITaskSeriesCommand, INotificationCommand, ITriggerScaleMonitor<QueueTriggerMetrics>
    {
        ...
        // TODO: not really happy with the generic/non-generic requirements of this interface. However,
        // the functions host needs the non-generic interfaces and uses the generic type args to know what
        // types to deserialize metrics into.
